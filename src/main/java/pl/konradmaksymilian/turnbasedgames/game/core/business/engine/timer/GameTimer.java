package pl.konradmaksymilian.turnbasedgames.game.core.business.engine.timer;
...
public abstract class GameTimer {
	...
	protected synchronized void schedule(Duration time, Runnable onTimeEnd) {
		...
		currentExecution = executor.schedule(onTimeEnd, time.toMillis(), TimeUnit.MILLISECONDS);
