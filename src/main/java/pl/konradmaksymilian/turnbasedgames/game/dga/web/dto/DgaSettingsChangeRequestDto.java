...
import pl.konradmaksymilian.turnbasedgames.game.core.web.dto.GameSettingsChangeRequestDto;
import pl.konradmaksymilian.turnbasedgames.game.dga.data.BoardSize;

public class DgaSettingsChangeRequestDto implements GameSettingsChangeRequestDto {
	...
	public DgaSettingsChangeRequestDto(@JsonProperty("boardSize") BoardSize boardSize,
